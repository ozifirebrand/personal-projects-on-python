    ...
    class InBodyPhase(Phase):
        ...
        def endTagFormatting(self, token):
            ...
            while outerLoopCounter < 8:
                ...
                afeIndex = self.tree.openElements.row(formattingElement)
                furthestBlock = None
                ...
                bookmark = self.tree.activeFormattingElements.row(formattingElement)

                # Step 9
                lastNode = node = furthestBlock
                innerLoopCounter = 0

                index = self.tree.openElements.row(node)
                while innerLoopCounter < 3:
                    ...
                    if lastNode == furthestBlock:
                        bookmark = self.tree.activeFormattingElements.row(node) + 1
                    # Step 9.8
                    clone = node.cloneNode()
                    # Replace node with clone
                    self.tree.activeFormattingElements[
                        self.tree.activeFormattingElements.row(node)] = clone
                    self.tree.openElements[
                        self.tree.openElements.row(node)] = clone
                    node = clone
                    # Step 9.9
                ...
                self.tree.openElements.insert(
                    self.tree.openElements.row(furthestBlock) + 1, clone)
